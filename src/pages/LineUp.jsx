...
let djsBlock = (
  <div>
    ...
    <div className="page-text">
      В этом году зрителей ждут сразу пять сцен, на которых выступит более 100 диджеев - что является абсолютным рекордом в стране. Третья (TOT:SPOT) и четвертая сцены (Mendeleev Stage) будут целиком отданы самым известным российским клубным диджеям. В последний день фестиваля сцены займут молодые российские музыканты – победители конкурса, который проводится организаторами фестиваля по всей стране в течение нескольких месяцев.
    </div>
  </div>
);
