    ...
    },
    {
      ...
      text: (
        <div>
          ...
          <p className="screen-text">
            1. Зрителям, купившим билеты на парковку фестиваля – нужно ознакомиться со схемами проезда на фестиваль в разделах
            «Из Москвы» или «Из Нижнего Новгорода», в зависимости от того с какой стороны вы будете ехать.
