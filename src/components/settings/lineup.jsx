export const lineUpMain = {
  '2016': {
    ...
    ' диджей мира по версии Dj MAG TOP 100 и фактически икона транс музыки.' +
    ' Cенсационные диджеи номер 1 в мире - братья Dimitri Vegas & Like Mike,' +
    ...
    ' которые готовят свое шоу специально для фестиваля AFP 2016</p>',
