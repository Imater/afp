export const partners = [
  ...
  },
  {
    ...
    desc: 'Mentos - глобальный бренд, который можно купить более чем в 150 странах мира. В России бренд присутствует с 1994 года. Это  культ для целого поколения молодых людей! Линейку продуктов Mentos  составляют  уникальные жевательные резинки и драже самых разнообразных вкусов. Бренд широко известен российскому потребителю благодаря своим ярким и необычным рекламным кампаниям. Mentos – партнер фестиваля ALFA FUTURE PEOPLE.',
    desc_eng: ''
  },
  {
    ...
    title_eng: 'Perrier',
    years: ['2016'],
    url: 'https://www.facebook.com/Perrier/',
    desc: 'Perrier – знаменитая французская минеральная вода из древнего источника, расположенного на юге Франции. Это одно из немногих мест на земле, где подземный источник и натуральный вулканический газ соединяются вместе, чтобы создать шипучую, «искрящуюся» воду. Perrier – идеальный утолитель жажды, аперитив, дижестив и ингредиент для коктейлей. Элегантная и инновационная, легендарная зеленая бутылочка Perrier всегда в центре самых модных событий. Минеральная вода Perrier представлена в  140 странах мира. Ежегодно в мире продается 800 миллионов бутылок воды этой марки.',
    desc_eng: ''
  },
  {
