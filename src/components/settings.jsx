...
export const aboutMain = {
  ...
  goodsList: [
    ...
    },
    {
      ...
      text_eng: 'На 100% уверены, что едете на фестиваль? Тогда купите билеты на поезд заранее.'
    },
    {
      ...
      text_eng: 'Попробуйте заранее найти попутчиков, которые поедут на фестиваль из вашего города. Это можно сделать в группах AFP в соцсетях.'
    },
    {
      ...
      text_eng: 'Если планируете встретиться с друзьями уже на фестивале, заранее изучите план территории на сайте.'
    },
    {
      icon: 'icon-money.svg',
      ...
      text_eng: 'Убедитесь, что на счету уже имеющейся у вас карты достаточно средств, или возьмите с собой наличные, чтобы внести их в банкомат на фестивале.'
    },
    {
      icon: 'icon-sleep.svg',
      ...
      text_eng: 'Выспитесь. Программа фестиваля очень насыщенная, и множество мероприятий будут проходить в ночное время, поэтому вряд ли вы будете рады, если проспите что-то интересное.'
    },
    {
      icon: 'icon-plan.svg',
      ...
      text_eng: 'Распланируйте свои фестивальные дни так, чтобы получить максимум удовольствия. Заранее определитесь, какие мероприятия и выступления вы хотите посетить.'
    },
    {
      icon: 'icon-safe.svg',
      text: 'Следите за своими личными вещами. Для комфортного пребывания на фестивале, рекомендуем взять в аренду камеру хранения.',
      text_eng: 'Следите за своими личными вещами. Для комфортного пребывания на фестивале, рекомендуем взять в аренду камеру хранения.'
    },
  ],
  howToGetThere: {
    title: 'Как добраться?',
