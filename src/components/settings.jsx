...
export const faqItems = [
  ...
  },
  {
    ...
    title_eng: '',
    text: 'За территорией фестиваля гости также могут разместить свои собственные палатки. Но, обращаем ваше внимание на то, что разместиться «дикарями» вы сможете достаточно далеко от фестиваля, и никаких удобств там не предусмотрено. Мы не рекомендуют создавать подобные палаточные лагеря «дикарями», потому что согласно местному региональному закону сотрудники полиции и МЧС вправе запрещать размещение палаток и проживание в них. Это связано с ежегодной пожароопасной ситуацией в Нижегородской области. Также мы не можем гарантировать вашу личную безопасность при размещении вне зоны безопасности фестиваля.',
    text_eng: ''
  },
  {
    heading: '',
  ...
  },
  {
    ...
    title_eng: '',
    text: 'Вход на территорию фестиваля с любыми напитками в любой емкости, включая пластиковые бутылки, запрещен. Вы можете привезти с собой любое количество еды и напитков (кроме стеклянных емкостей и алкоголя), если хотите разместиться в альфа-кемпинге или в омега-кемпинге. Но все, что вы привезете с собой, нужно будет оставить в кемпинге в палатке или в машине, потому что проход из палаточного городка / с парковки на территорию фестиваля со своими напитками и едой (в любой емкости) запрещен.',
    text_eng: ''
  },
  {
    heading: '',
  ...
  },
  {
    heading: '',
    heading_eng: '',
    title: 'Насколько жесткие меры безопасности планируются на фестивале?',
    title_eng: '',
  ...
  },
  {
    ...
    title_eng: '',
    text: 'Пожалуйста, уточните условия у Директора по работе с партнерами Екатерины Осадчей по электронной почте <a href="mailto:EOsadchaya@alfabank.ru">EOsadchaya@alfabank.ru</a>',
    text_eng: ''
  },
  {
    heading: '',
...
export const store =
  {
    title: 'Эксклюзивная<br/>атрибутика фестиваля',
    title_eng: '',
    desc: 'Если вы хотите приобрести экcклюзивную атрибутику фестиваля Alfa Future People обратитесь пожалуста к нашим официальным партнерам',
    desc_eng: '',
    button: 'Фотографии',
    button_eng: 'Photos',
    image: 'bg.jpg',
...
export const storePartners = [
  {
    logo: 'logo-mimoda.svg',
    name: 'mastercard',
    title: 'Магазин Mimoda',
    title_eng: '',
    url: 'mimoda.ru/category/afp',
    desc: 'Адрес: г.Москва, Климентовский пер. д.12 стр.6 <br/>Телефон: <a href="tel:+74997071669">+7 (499) 707-16-69</a>, <a href="tel:+79854257539">(985) 425-75-39</a> <br/>Электронная почта: <a href="mailto:info@mimoda.ru">info@mimoda.ru</a> <br/>Доставка по России',
    desc_eng: ''
  },
  {
    logo: 'logo-acidwear.svg',
    name: 'mastercard',
...
export const storeImages = [
  ...
  {
    image: '9.jpg',
    link1: 'http://www.mimoda.ru/product/svitshot-afp_0q/',
    link2: 'http://www.acidwear.ru/index.php?id=8255',
  },
  {
    image: '9(2).jpg',
    link1: 'http://www.mimoda.ru/product/svitshot-afp_0q/',
  ...
  {
    image: '6.jpg',
    link1: 'http://www.mimoda.ru/product/kombinezon-afp/',
    link2: 'http://www.acidwear.ru/index.php?id=8240',
  },
  {
    image: '6(2).jpg',
    link1: 'http://www.mimoda.ru/product/kombinezon-afp/',
  ...
  {
    image: '7.jpg',
    link1: 'http://www.mimoda.ru/product/majka-afp/',
    link2: 'http://www.acidwear.ru/index.php?id=8250',
  },
  {
    image: '7(2).jpg',
    link1: 'http://www.mimoda.ru/product/majka-afp/',
  ...
  {
    image: '11.jpg',
    link1: 'http://www.mimoda.ru/product/majka-afp_e2/',
    link2: 'http://www.acidwear.ru/index.php?id=8251',
  },
  {
    image: '11(2).jpg',
    link1: 'http://www.mimoda.ru/product/majka-afp_e2/',
  ...
  {
    image: '12.jpg',
    link1: 'http://www.mimoda.ru/product/majka-afp_z8/',
    link2: 'http://www.acidwear.ru/index.php?id=8252',
  },
  {
    image: '12(2).jpg',
    link1: 'http://www.mimoda.ru/product/majka-afp_z8/',
  ...
  {
    image: '13.jpg',
    link1: 'http://www.mimoda.ru/product/polo-afp/',
    link2: 'http://www.acidwear.ru/index.php?id=8253',
  },
  {
    image: '13(2).jpg',
    link1: 'http://www.mimoda.ru/product/polo-afp/',
  ...
  {
    image: '3.jpg',
    link1: 'http://www.mimoda.ru/product/polo-afp_2c/',
    link2: 'http://www.acidwear.ru/index.php?id=8249',
  },
  {
    image: '3(2).jpg',
    link1: 'http://www.mimoda.ru/product/polo-afp_2c/',
  ...
  {
    image: '2.jpg',
    link1: 'http://www.mimoda.ru/product/svitshot-afp/',
    link2: 'http://www.acidwear.ru/index.php?id=8243',
  },
  {
    image: '2(2).jpg',
    link1: 'http://www.mimoda.ru/product/svitshot-afp/',
  ...
  {
    image: '15.jpg',
    link1: 'http://www.mimoda.ru/product/tolstovka-afp-_pd/',
    link2: 'http://www.mimoda.ru/product/tolstovka-afp-_pd/',
  },
  {
    image: '15(2).jpg',
    link1: 'http://www.mimoda.ru/product/tolstovka-afp-_pd/',
  ...
  {
    image: '17.jpg',
    link1: 'http://www.mimoda.ru/product/tolstovka-afp-_pk/',
    link2: 'http://www.acidwear.ru/index.php?id=8244',
  },
  {
    image: '1.jpg',
    link1: 'http://www.mimoda.ru/product/tolstovka-afp-/',
    link2: 'http://www.acidwear.ru/index.php?id=8241',
  },
  {
    image: '1(2).jpg',
    link1: 'http://www.mimoda.ru/product/tolstovka-afp-/',
  ...
  {
    image: '13.jpg',
    link1: 'http://www.mimoda.ru/product/futbolka-afp/',
    link2: 'http://www.acidwear.ru/index.php?id=8246',
  },
  {
    image: '14.jpg',
    link1: 'http://www.mimoda.ru/product/futbolka-afp/',
  ...
  {
    image: '5.jpg',
    link1: 'http://www.mimoda.ru/product/futbolka-afp_ju/',
    link2: 'http://www.acidwear.ru/index.php?id=8247',
  },
  {
    image: '4.jpg',
    link1: 'http://www.mimoda.ru/product/futbolka-afp_q2/',
    http2: 'http://www.acidwear.ru/index.php?id=8248',
  },
  {
    image: '8.jpg',
    link1: 'http://www.mimoda.ru/product/jubka-afp/',
    link2: 'http://www.acidwear.ru/index.php?id=8461',
  }
