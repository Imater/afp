...
export const personList = [
  ...
  },
  {
    ...
    job: 'Вопросы по фудкорту, кемпингам',
    job_eng: 'Food court, camping',
    email: 'kozhaev@afp.ru'
  },
  {
  ...
  {
    name: 'Антон Куклин',
    name_eng: 'Anton Kuklin',
    job: 'Вопросы по зоне Vip',
    job_eng: 'Vip zone',
...
export const faqItems = [
  ...
  },
  {
    ...
    title_eng: '',
    text: 'Зона технологий - это несколько павильонов, расположенных в центральной части территории фестиваля. Здесь будут представлены последние достижения технологических компаний в различных сферах - транспорт, гаджеты, средства связи, игры и т.д.<br />Поучаствовать в аттракционах можно будет бесплатно, или необходимо это оплачивать отдельно?<br /><br />Большинство аттракционов будут бесплатными. Некоторые - будут оплачиваться отдельно, но их стоимость будет относительно невысока. Информация будет уточняться и дополняться ближе в датам фестиваля. В любом случае - вход в зону технологий бесплатный для всех желающих.',
    text_eng: ''
  },
  {
    heading: '',
  ...
  },
  {
    ...
    title_eng: '',
    text: '500 руб. – депозит (потом возвращается) / 500 руб. - камера хранения на весь период проведения Фестиваля. Камеры хранения установлены перед входом на территорию Фестиваля. Оплата наличными.',
    text_eng: ''
  },
  {
    heading: '',
